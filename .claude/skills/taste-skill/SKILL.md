...
name: taste-skill
description: >-
  Anti-slop frontend design taste — contextual rules for layout, typography,
  type scale, color, spacing, and motion. Load before designing or polishing a
  visual/marketing UI (landing pages, portfolios, covers, redesigns) to avoid
  generic AI-looking output. Source: github.com/Leonxlnx/taste-skill.
---
...
**End of Skill Document.** This is the complete reference material for the anti-slop frontend design skill.